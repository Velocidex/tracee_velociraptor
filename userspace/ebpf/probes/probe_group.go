...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool, defaultAutoload bool, binaryPath string) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		SyscallTableCheck:          NewFixedUprobe(Uprobe, "uprobe_syscall_table_check", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerSyscallTableIntegrityCheckCall")),
		HiddenKernelModuleSeeker:   NewFixedUprobe(Uprobe, "uprobe_lkm_seeker", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerKernelModuleSeeker")),
		HiddenKernelModuleVerifier: NewFixedUprobe(Uprobe, "uprobe_lkm_seeker_submitter", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerKernelModuleSubmitter")),
		PrintNetSeqOps:             NewFixedUprobe(Uprobe, "uprobe_seq_ops_trigger", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerSeqOpsIntegrityCheckCall")),
		PrintMemDump:               NewFixedUprobe(Uprobe, "uprobe_mem_dump_trigger", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerMemDumpCall")),
		...
		SignalHeartbeat:            NewFixedUprobe(Uprobe, "heartbeat_capture", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/server/http.invokeHeartbeat")),
		...
		FeaturesFallbackArena: NewFixedUprobeWithCompatibility(Uprobe, "uprobe__features_fallback_arena", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerFeaturesFallbackTestCall"), NewProbeCompatibility(
		...
		FeaturesFallbackHelper: NewFixedUprobeWithCompatibility(Uprobe, "uprobe__features_fallback_helper", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerFeaturesFallbackTestCall"), NewProbeCompatibility(
			NewBPFHelperRequirement(bpf.BPFProgTypeKprobe, bpf.BPFFuncGetCurrentTaskBtf),
		)),

		// Level 3: basic uprobe (universal fallback)
		FeaturesFallbackMinimal: NewFixedUprobe(Uprobe, "uprobe__features_fallback_minimal", binaryPath, UprobeEventSymbol("github.com/Velocidex/tracee_velociraptor/userspace/ebpf.(*Tracee).triggerFeaturesFallbackTestCall")),
	}
