...
import (
	...
	"github.com/Velocidex/tracee_velociraptor/userspace/capabilities"
...
func (m *Manager) CreateUserlandIterator() interfaces.Iterator[*Policy] {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *Manager) CreateAllIterator() interfaces.Iterator[*Policy] {
	m.mu.RLock()
	defer m.mu.RUnlock()
