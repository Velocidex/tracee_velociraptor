...
struct policies_config_version {
    ...
    __type(key, u16);
    __array(values, struct policies_config_map);
...
struct uid_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct uid_filter);
...
struct pid_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct pid_filter);
...
struct mnt_ns_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct mnt_ns_filter);
...
struct pid_ns_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct pid_ns_filter);
...
struct uts_ns_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct uts_ns_filter);
...
struct data_filter_exact_version {
    ...
    __array(values, struct data_filter_exact);
...
struct data_filter_suffix_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, policy_key_t);
    __array(values, struct data_filter_suffix);
...
struct data_filter_prefix_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, policy_key_t);
    __array(values, struct data_filter_prefix);
...
struct comm_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct comm_filter);
...
struct cgroup_id_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct cgroup_id_filter);
...
struct binary_filter_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct binary_filter);
...
struct process_tree_map_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct process_tree_map);
...
struct events_map_version {
    ...
    __uint(max_entries, MAX_FILTER_VERSION);
    __type(key, u16);
    __array(values, struct events_map);
